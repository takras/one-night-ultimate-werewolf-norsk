...
const translations = {
  no: {
    ...
    seconds: 'sekunder',
    oracleRipplePrompt: 'Garanterte Orakelet en ripple?',
    yesLabel: 'Ja',
    noLabel: 'Nei',
    ...
    rippleEventsGroupLabel: 'Ripple-effekter (Forstyrrelse i tiden)',
    fragmentInfo: 'Korte klipp som limes sammen med en aktiveringslyd i spillet, f.eks. «spiller til venstre» eller et spillernummer, i stedet for å spille inn hver mulige setning på nytt. Ripple-effektene spilles ikke av automatisk ennå - fortelleren må trigge dem manuelt ved bordet.',
  ...
  en: {
    ...
    seconds: 'seconds',
    oracleRipplePrompt: 'Did the Oracle guarantee a ripple?',
    yesLabel: 'Yes',
    noLabel: 'No',
    ...
    rippleEventsGroupLabel: 'Ripple events (Time Disturbance)',
    fragmentInfo: 'Short clips spliced onto an activation clip during the game, e.g. "player to the left" or a player number, instead of re-recording every possible sentence. Ripple events don\'t play automatically yet - the narrator has to trigger them manually at the table.',
